...
def test_grid_stack():
    ...
    assert grid_stack.grids.__len__() == 4

    assert grid_stack.grids[0].refinement_level == 1
    assert grid_stack.grids[0].cells == [CellID('O0')]

    assert grid_stack.grids[1].refinement_level == 2
    assert grid_stack.grids[1].cells == [CellID('N11'), CellID('N12'), CellID('N13'), CellID('N88')]

    assert grid_stack.grids[2].refinement_level == 3
    assert grid_stack.grids[2].cells == [CellID('P123')]

    assert grid_stack.grids[3].refinement_level == 5
    assert grid_stack.grids[3].cells == [CellID('S34567')]
